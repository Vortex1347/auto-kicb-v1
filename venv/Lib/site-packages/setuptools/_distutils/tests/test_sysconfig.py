"""tests.py for distutils.sysconfig."""
...
class TestSysconfig:
    ...
    # builds, which happens earlier in the Distutils tests.py. This may
    # cause the following tests.py to fail since no tests.py have caused
