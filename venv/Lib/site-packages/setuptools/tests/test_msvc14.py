"""
tests.py for msvc support module (msvc14 unit tests.py).
"""
...
@pytest.mark.skipif(sys.platform != "win32", reason="These tests.py are only for win32")
class TestMSVC14:
    """Python 3.8 "distutils/tests.py/test_msvccompiler.py" backport"""
