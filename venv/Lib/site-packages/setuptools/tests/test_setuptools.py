"""tests.py for the 'setuptools' package"""
...
def makeSetup(**args):
    ...
    # Don't let system command line leak into tests.py!
...
class TestDepends:
    ...
    def testFindModule(self):
        ...
        f, p, i = dep.find_module('setuptools.tests.py')
        f.close()
    ...
    def testModuleExtract(self):
        ...
        assert (
            dep.get_module_constant('setuptools.tests.py.test_setuptools', '__doc__')
            == __doc__
        )
    ...
    def test_require_present(self):
        ...
        req = Require('tests.py', None, 'tests.py', homepage="http://example.com")
        assert req.format is None
        assert req.attribute is None
        assert req.requested_version is None
        assert req.full_name() == 'tests.py'
...
@pytest.mark.xfail(reason="unable to exclude tests.py; #4475 #3260")
