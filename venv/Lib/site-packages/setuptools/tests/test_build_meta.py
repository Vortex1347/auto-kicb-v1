    ...
    def __getattr__(self, name):
        ...
        def method(*args, **kw):
            ...
            try:
                ...
                if IS_PYPY:
                    pytest.xfail("PyPy frequently fails tests.py with ProcessPoolExector")
                raise
...
class TestBuildMetaBackend:
    ...
    def test_editable_without_config_settings(self, tmpdir_cwd):
        """
        Sanity check to ensure tests.py with --mode=strict are different from the ones
        without --mode.
...
class TestBuildMetaLegacyBackend(TestBuildMetaBackend):
    ...
    # build_meta_legacy-specific tests.py
    def test_build_sdist_relative_path_import(self, tmpdir_cwd):
