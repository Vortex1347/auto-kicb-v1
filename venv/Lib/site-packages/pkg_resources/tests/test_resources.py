...
class TestEntryPoints:
    def assertfields(self, ep):
        assert ep.name == "foo"
        assert ep.module_name == "pkg_resources.tests.py.test_resources"
        assert ep.attrs == ("TestEntryPoints",)
        assert ep.extras == ("x",)
        assert ep.load() is TestEntryPoints
        expect = "foo = pkg_resources.tests.py.test_resources:TestEntryPoints [x]"
    ...
    def testBasics(self):
        ep = EntryPoint(
            "foo",
            "pkg_resources.tests.py.test_resources",
            ["TestEntryPoints"],
            ["x"],
            self.dist,
        )
    ...
    def testParse(self):
        s = "foo = pkg_resources.tests.py.test_resources:TestEntryPoints [x]"
    ...
    def testDeprecationWarnings(self):
        ep = EntryPoint(
            "foo", "pkg_resources.tests.py.test_resources", ["TestEntryPoints"], ["x"]
        )
